...
; 		sstapelb 06.08.2013 changed bin2_bounds to biny_bounds due to email claudia stubenrauch
		...
		NCDF_ATTPUT,idout,'grid_resolution_in_degrees',string(resolution,f='(f3.1)'),/GLOBAL,/CHAR
		NCDF_ATTPUT,idout,'contact',self.contact,/GLOBAL,/CHAR
		NCDF_ATTPUT,idout,'history',systime()+': Generated by '+getenv('USER')+' on '+getenv('HOST'),/GLOBAL,/CHAR
